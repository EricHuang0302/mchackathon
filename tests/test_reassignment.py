...
from agent.app.services.candidates import CandidateSearchConfig
from agent.app.services.routing import DeterministicFakeRouteProvider
from tests.conftest import HELPER_POINT, PATIENT_POINT, make_record
...
def test_helper_at_the_first_aed_still_reassigns_when_it_is_unavailable(now):
    ...
    from tests.conftest import helper_status_at
