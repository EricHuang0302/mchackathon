...
MODELS = [
    ...
    c.SceneTranscriptionRequest, c.SceneTranscriptionResponse,
    c.SceneTextReportRequest, c.SceneTextObservationProposal, c.SceneTextPlanStep,
    c.SceneTextPlan, c.SceneTextReportResponse,
...
def build():
    ...
    paths = {
        ...
        "/v1/incidents/{incidentId}/scene-text-reports": {"parameters": [incident], "post": operation("Extract unconfirmed proposals from one typed scene report", c.SceneTextReportRequest, c.SceneTextReportResponse)},
        "/v1/incidents/{incidentId}/scene-transcriptions": {"parameters": [incident], "post": operation("Transcribe one recorded scene report for the user to review", c.SceneTranscriptionRequest, c.SceneTranscriptionResponse)},
