...
from agent.app.services.handoff import HANDOFF_DETAIL_ALLOWLIST, decode_cursor
...
def test_greeter_is_refused_the_timeline_but_keeps_the_snapshot(world, factory) -> None:
    ...
    from agent.app.services import ROLE_CAPABILITIES
    from agent.app.services.access import READ_SCENE_SNAPSHOT
