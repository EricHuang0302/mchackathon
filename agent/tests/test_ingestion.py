...
from agent.app.services import ROLE_AED_RUNNER, ROLE_EMS_VIEWER, ServiceError
from agent.app.services import event_types as et
from agent.app.services.errors import (
    INVALID_INPUT,
    RULE_MISMATCH,
    STALE_REVISION,
    UNAUTHORIZED,
...
def test_principal_scoped_to_another_incident_is_refused(world, factory):
    from agent.app.services import ROLE_PRIMARY, Principal, ROLE_CAPABILITIES
