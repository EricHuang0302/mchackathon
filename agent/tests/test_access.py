...
These are the service-side equivalents of the Firestore Rules cases in
``firebase/tests/``. The backend must enforce them itself because Admin SDK
writes bypass Security Rules entirely.
"""
...
from agent.app.services import ServiceError
from agent.app.services.access import (
    MANAGE_SHARES,
    READ_MIST,
    READ_SCENE_SNAPSHOT,
    READ_TIMELINE,
